...
public class MessageRepository : IMessageRepository
{
    ...
    public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
    {
        ...
        query = messageParams.Container switch
        {
            ...
            && u.ReceiientDeleted == false),
            "Outbox" => query.Where(u => u.SenderUserName == messageParams.UserName
            && u.SenderDeleted == false),
            _ => query.Where(u => u.RecipientUserName == messageParams.UserName && u.ReceiientDeleted == false
            && u.DateRead == null)
        };
    ...
    public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUserName, string recepientUserName)
    {
        var messages = await _context.Messages
            ...
            .Where(
                m => m.RecipientUserName == currentUserName && m.ReceiientDeleted == false &&
